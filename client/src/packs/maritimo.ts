...
export const maritimo: IndustryPack = {
  ...
  operacion: {
    sedes: ["Base Valparaíso", "Base San Antonio", "Base Mejillones", "Base San Vicente", "Base Puerto Montt"],
    unidades: ["Operaciones Valparaíso", "Operaciones San Antonio", "Operaciones Mejillones", "Operaciones San Vicente", "Operaciones Puerto Montt", "Servicios Offshore", "Mantenimiento y Flota"],
    cargosOperativos: [
      { cargo: "Marinero", peso: 5, sueldo: [900_000, 1_400_000] },
      { cargo: "Contramaestre", peso: 2, sueldo: [1_300_000, 1_900_000] },
      { cargo: "Oficial de Máquinas", peso: 2, sueldo: [1_800_000, 2_600_000] },
    ...
    etiquetaActivo: "Remolcador",
    activos: ["RAM Valparaíso", "RAM Aconcagua", "RAM Bío-Bío", "RAM Loa", "RAM Huasco", "RAM Maipo", "RAM Cautín", "RAM Petrohué", "RAM Reloncaví", "RAM Chacao", "RAM Corral", "RAM Lebu", "RAM Elqui", "RAM Copiapó", "RAM Rapel", "RAM Toltén"],
    etiquetaDotacion: "dotación embarcada",
    etiquetaFaena: "faena",
    actividades: ["Maniobra de atraque portacontenedores", "Asistencia a nave granelera", "Remolque de barcaza", "Faena offshore apoyo plataforma", "Zarpe de nave tanque", "Escolta carga peligrosa", "Salvamento y rescate en rada", "Emergencia por temporal", "Recalada crucero", "Maniobra de desatraque", "Asistencia a nave con falla de máquinas", "Traslado de pontón", "Apoyo a faena de dragado", "Amarre de nave frigorífica"],
    ciudades: ["Valparaíso", "Quintero", "San Antonio", "San Vicente", "Talcahuano", "Coronel", "Mejillones", "Antofagasta", "Iquique", "Arica", "Coquimbo", "Lirquén", "Puerto Montt", "Chacabuco", "Punta Arenas"],
    tiposVehiculo: ["Camioneta pool", "Camioneta 4x4", "Bus de relevo", "SUV supervisión", "Van traslado tripulación"],
    convenios: ["Convenio Marítimo 2024-2027", "Sindicato Tierra 2025-2027"],
    bonosConvenio: ["Bono de embarque", "Bono de guardia nocturna", "Bono de faena", "Bono de relevo", "Bono de dotación completa", "Asignación de zona", "Asignación de colación"],
    bonoPrincipal: "Bono de embarque",
